...
type KidsDetailPageProps = {
  params: {
    id: string;
  };
};

const KidsDetailPage: React.FC<KidsDetailPageProps> = ({ params }) => {
    ...
    <>
      <div className="mt-16">
        ...
        <div className="flex flex-col  gap-8 mt-16 mb-36 px-16">
          <div className="flex  w-full p-14 border-b-2 border-[#c4c4c4]">
          ...
          <div className="flex gap-[362px]">
            ...
            <ul>
              ...
              <li className="list-disc text-base font-semibold text-[#212121]">
                Lorem ipsum dolor sit amet
              </li>
            </ul>
          </div>
