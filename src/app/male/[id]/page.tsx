...
type MaleDetailPageProps = {
  params: {
    id: string;
  };
};

const MaleDetailPage: React.FC<MaleDetailPageProps> = ({ params }) => {
  ...
  return (
    <>
      <div className="mt-16">
        ...
        {/* Product detail */}
        <div className="flex flex-col  gap-8 mt-16 mb-36 px-20">
